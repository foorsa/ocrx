...
DOCUMENT_DEFINITIONS = [
    {
        ...
        "documents": [
            ...
            },
            {
                ...
                "fields": [
                    {"name": "Province", "description": "Name of the Provincial / Regional Academy of Education and Training", "example": '"Rabat", "Casablanca-Settat", "Fes-Meknes", etc.'},
                    {"name": "Serial Number", "description": "Serial number of the Baccalaureate Certificate", "example": '"C123456789", "K137260939", etc.'},
                    {"name": "Student Name", "description": "Full name of the student", "example": '"Mohamed Ali", "Yassine Chettouch", etc.'},
                    {"name": "Date", "description": "Date of the jury's deliberation", "example": '"12/07/2023", "15/06/2022", etc.'},
                    {"name": "Id Card Number", "description": "National identity card number of the candidate", "example": '"AB123456", "CD789012", etc.'},
                    {"name": "Institute", "description": "Name of the high school / institute of the candidate", "example": '"Mohamed V", "Hassan II", "Ibn Sina", etc.'},
                    {"name": "Session", "description": "Session year and month of the baccalaureate exam", "example": '"July 2023", "June 2022", etc.'},
                    {"name": "Series", "description": "Branch / series of the baccalaureate", "example": '"Economic Sciences", "Mathematics", "Life and Earth Sciences", etc.'},
                    {"name": "Option", "description": "Specialty / option within the series", "example": '"Economics and Management", "Physical Sciences", etc.'},
                    {"name": "Grade", "description": "Mention / grade obtained by the candidate", "example": '"Excellent", "Very Good", "Good", "Passable", etc.'},
                    {"name": "Date of issue", "description": "Date the certificate was issued", "example": '"12/03/2023", "01/11/2022", etc.'},
                ],
            },
            {
    ...
    },
    {
        ...
        "documents": [
                    ...
                    {"name": "City of issue", "description": "City of issue of the School Certificate"},
            {
                ...
                "name": "Bank Statement",
                "fields": [
                    {"name": "Bank Name", "description": "Name of the issuing bank", "example": '"Attijariwafa Bank", "CIH Bank", "Banque Populaire", etc.'},
                    {"name": "Branch Name", "description": "Name or location of the bank branch", "example": '"Agence Rabat Centre", "Agence Fes Ville", etc.'},
                    {"name": "Account Name", "description": "Full name of the account holder", "example": '"Mohamed El Alami", "Fatima Zahra Bennani", etc.'},
                    {"name": "Date", "description": "Date of the bank statement / certificate", "example": '"01/03/2024", "15/07/2023", etc.'},
                    {"name": "bank details", "description": "Bank account details such as account number or RIB", "example": '"RIB: 123 456 7890123456789 01", etc.'},
                    {"name": "Balance Amount", "description": "Current account balance in Moroccan Dirhams (DHS)", "example": '"25,000.00 DHS", "150,000 DHS", etc.'},
                    {"name": "City of issue", "description": "City where the statement was issued", "example": '"Rabat", "Casablanca", "Fes", etc.'},
                    {"name": "Date of issue", "description": "Official date the document was issued", "example": '"01/03/2024", "15/07/2023", etc.'},
                ],
            },
            {
                ...
                "fields": [
                    {"name": "Birth Certificate No.", "description": "Registration number of the birth certificate (Acte N°)", "example": '"173/", "245/", etc.'},
                    {"name": "Register Year", "description": "Gregorian year of registration", "example": '"2008", "2001", etc.'},
                    {"name": "First Name", "description": "First name (Prénom) of the person on the certificate", "example": '"Kaoutar", "Youssef", etc.'},
                    {"name": "Last Name", "description": "Family name (Nom) of the person on the certificate", "example": '"Hichmine", "El Alami", etc.'},
                    {"name": "Date of birth", "description": "Date of birth written in words in Arabic / French (Hijri calendar)", "example": '"Cinq Chaoual mille quatre cent vingt neuf", etc.'},
                    {"name": "Place of birth", "description": "Place of birth (Lieu de Naissance)", "example": '"Douar Tourtoute Commune Ait Seghrouchen", "Casablanca", etc.'},
                    {"name": "Hijri date", "description": "Hijri (Islamic calendar) date corresponding to the date of birth", "example": '"1429 Hég", "1402 Hég", etc.'},
                    {"name": "Gender", "description": "Gender of the person (de Sexe)", "example": '"Male", "Female"'},
                    {"name": "Father's Name", "description": "Full name of the father (Fils/Fille de)", "example": '"Driss Fils de Belkacem", "Mohamed Ben Ahmed", etc.'},
                    {"name": "Mother's Name", "description": "Full name of the mother (Et de)", "example": '"Hassania Fille de Ali Lamaalem", "Fatima Bint Omar", etc.'},
                    {"name": "City of issue", "description": "City where the certificate was issued", "example": '"Taza", "Rabat", "Fes", etc.'},
                    {"name": "Date of issue", "description": "Date the certificate was officially issued", "example": '"17/09/2025", "01/03/2024", etc.'},
                ],
            },
            {
                ...
                "fields": [
                    {"name": "Death certificate number", "description": "Registration number of the death certificate", "example": '"45/", "128/", etc.'},
                    {"name": "First Name", "description": "First name of the deceased", "example": '"Mohamed", "Fatima", etc.'},
                    {"name": "Last Name", "description": "Family name of the deceased", "example": '"El Alami", "Benali", etc.'},
                    {"name": "Father's Name", "description": "Full name of the deceased's father", "example": '"Ahmed Ben Hassan", "Omar Fils de Youssef", etc.'},
                    {"name": "Mother's Name", "description": "Full name of the deceased's mother", "example": '"Khadija Bint Ali", "Fatima Fille de Driss", etc.'},
                    {"name": "Place of death", "description": "Place / city where the person passed away", "example": '"Casablanca", "Rabat", "Douar Ait Said", etc.'},
                    {"name": "Date of death (Hijri)", "description": "Date of death in the Hijri (Islamic) calendar, written in words", "example": '"Khamsa wa Ishrin min Ramadan 1443", etc.'},
                    {"name": "Date of death (Gregorian)", "description": "Date of death in the Gregorian calendar", "example": '"27/04/2022", "15/09/2019", etc.'},
                    {"name": "City of issue", "description": "City where the death certificate was issued", "example": '"Casablanca", "Rabat", "Fes", etc.'},
                    {"name": "Date of issue", "description": "Date the death certificate was officially issued", "example": '"01/03/2024", "15/07/2023", etc.'},
                ],
            },
        ],
    },
...
def StreamTextAndTablesFromText(Doctype, Text):
    ...
    match Doctype:
        ...
        case "Baccalaureate-Transcript-of-Marks-V2":
            table_format = (
                '"tables": {"Transcript": {"Columns": ["Subjects", "YYYY/YYYY S1", "YYYY/YYYY S2", "YYYY/YYYY S1", "YYYY/YYYY S2", "YYYY/YYYY S1", "YYYY/YYYY CC", "Regional Exam", "National Exam"], '
                '"Rows": [["Subject Name", "grade", "grade", "grade", "grade", "grade", "grade", "grade", "grade"], ..., ["Semester Average", ...], ["Annual Average", ...]]}, '
                '"Overall": {"Columns": ["Average of Continuous Control", "Regional Exam Average", "National Exam Average", "Overall Average"], '
                '"Rows": [["value", "value", "value", "value"]]}}'
            )
