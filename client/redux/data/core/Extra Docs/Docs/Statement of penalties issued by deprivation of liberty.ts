...
export const StatementOfPenaltiesIssuesByDeprivationOfLiberty: DocumentType = {
	...
	description:
		"Statement of penalties issued by deprivation of liberty is a document that contains the penalties issued by deprivation of liberty of the candidate. It is issued by the National Center for Examinations and Evaluations of the Ministry of National Education and Vocational Training of Morocco. It is issued in Arabic and French.",
	tags: ["Regular"],
	state: "Available",
	...
	fields: [
		{
			...
			type: "text",
			description:
				"Order Number of the penalty issued by deprivation of liberty.",
			required: true,
		...
		},
		{
			...
			type: "text",
			description:
				"City of issue of the Statement of penalties issued by deprivation of liberty.",
			required: true,
		},
		{
			name: "Date of issue",
			type: "text",
			description:
				"Date of issue of the Statement of penalties issued by deprivation of liberty.",
			required: true,
		},
	],
};
