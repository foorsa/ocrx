...
export const CertificateOfAchievement: DocumentType = {
	...
	description:
		"A certificate of achievement is a valuable tool designed to acknowledge and celebrate a student's successful accomplishment or attainment of a diploma. This document serves as a formal recognition of the individual's dedication, hard work, and commitment to their academic or personal goals.",
	tags: ["Regular"],
	state: "Available",
