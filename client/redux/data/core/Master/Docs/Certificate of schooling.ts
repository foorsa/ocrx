...
export const CertificateOfSchooling: DocumentType = {
	...
	description:
		"The certificate of schooling is a document that contains the schooling data of the candidate.",
	tags: ["Regular"],
	state: "Available",
	...
	fields: [
		...
		},
		{
			...
			type: "text",
			description:
				"Sector Session of the Candidate, e.g: 2019, 2020, etc.",
			required: true,
		},
		{
			name: "Sector Year",
			type: "text",
			description:
				"Sector Year of the Candidate, e.g: Third Year, Second Year, etc.",
			required: true,
		},
		{
			name: "Sector Name",
			type: "text",
			description:
				"Sector Name of the Candidate, e.g: Computer Science, etc.",
			required: true,
		},
		{
