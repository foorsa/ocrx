        ...
        <div className="relative w-full">
            ...
            {isUploading && (
                <button
                    disabled
                    type="button"
                    className="text-white w-full bg-black hover:bg-violet-800 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-violet-600 dark:hover:bg-violet-700 inline-flex items-center justify-center"
                >
                    <svg
                        aria-hidden="true"
                        role="status"
