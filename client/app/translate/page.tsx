    ...
    return (
        <>
            ...
            <div className="relative flex-1 h-full w-full min-w-full flex text-center flex-col justify-center items-center p-5">
                <div className="relative flex justify-center items-center h-16 w-16 aspect-square mb-10 p-1 bg-white border border-gray-200 rounded-lg shadow-2xl dark:bg-gray-800 dark:border-gray-700 select-none">
                    <img
                ...
                <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-2xl dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p className="mb-6 text-xs font-normal text-gray-700 dark:text-gray-400">
                        Begin the translation process by selecting the type of
                        document you wish to translate, and then uploading it
                        towards the server to be processed.
                        <Link
                            href="#"
