			...
			>
				...
				<div className="flex items-center">
					<button
						...
						type="button"
						className="flex-shrink-0 inline-flex justify-center items-center text-zinc-400 hover:bg-zinc-200 hover:text-zinc-900 rounded-xl text-sm p-1.5 dark:hover:bg-zinc-600 dark:hover:text-white"
						onClick={closeBanner}
					>
						<svg
							aria-hidden="true"
