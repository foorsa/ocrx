        ...
        >
            {Variant == "Home" ? (
                <>
                    ...
                    <div className="absolute h-full w-full min-h-screen top-0 left-0 right-0 bottom-0 -z-50 opacity-60 dark:opacity-60 overflow-hidden max-h-screen">
                ...
                <>
                    <div className="absolute h-full w-full min-h-screen top-0 left-0 right-0 bottom-0 -z-50 opacity-60 dark:opacity-100 max-h-screen">
                        <svg
