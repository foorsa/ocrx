...
export default function Jumbotron() {
    return (
        <div className="p-10 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1 className="fade-in-top-delay-500 mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 sm:text-6xl md:text-6xl lg:text-6xl dark:text-white">
            ...
            <p className="fade-in-top-delay-1000  delay-100 mb-8 text-lg font-normal text-violet-950 lg:text-xl sm:px-12 lg:px-48 dark:text-violet-100 text-opacity-75 dark:text-opacity-75">
            ...
            <div className="fade-in-top-delay-1500 delay-200 flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                <Link
                    href="/translate"
