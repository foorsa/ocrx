    ...
    return (
        <div className="p-10 mx-auto max-w-screen-xl text-center lg:py-16 flex flex-col justify-center items-center">
            ...
            >
                ...
                documents. Replace manual efforts with our AI-powered technology
                that generates accurate and professional documents in seconds.
                Say goodbye to time-consuming tasks and hello to increased
