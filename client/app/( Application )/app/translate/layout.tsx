...
const OCRX_ICON = ({ isLoading }: { isLoading: boolean }) => {
	...
	return (
		<div
			...
			} relative flex justify-center items-center h-16 w-16 aspect-square mb-10 p-1 bg-white border border-zinc-200 rounded-xl dark:bg-zinc-950 dark:border-zinc-700 select-none`}
		>
			<img
				src="/Logo/Black.png"
