		...
		<div className="flex flex-col gap-3 w-full">
			...
			>
				<label
					...
					className="flex flex-col items-center justify-center w-full h-64 border border-zinc-300 border-dashed rounded-xl cursor-pointer bg-zinc-50 dark:hover:bg-bray-800 dark:bg-zinc-900 hover:bg-zinc-100 dark:border-zinc-600 dark:hover:border-zinc-500 dark:hover:bg-zinc-800"
				>
				...
				{uploadedFile &&
					...
					uploadedFile !== null && (
						<motion.div
							...
							className="w-full mt-0 flex flex-col gap-3 z-10"
						>
							<div className="flex items-center w-full justify-between gap-3 px-2 py-2 bg-white border border-zinc-200 rounded-xl hover:bg-zinc-100 dark:bg-zinc-900 dark:border-zinc-800 dark:hover:bg-zinc-700 overflow-hidden">
								...
								<button
									className="p-2 text-zinc-500 hover:text-sky-500"
