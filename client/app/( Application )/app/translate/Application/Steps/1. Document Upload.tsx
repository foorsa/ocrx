...
export default function First_DocumentUpload() {
	...
	return (
		<div className="relative w-full">
			...
			{/* Batch progress bar — portaled to document.body to escape overflow-hidden + transforms */}
			{typeof document !== "undefined" && isBatchProcessing && totalCount > 0 && createPortal(
				<div
