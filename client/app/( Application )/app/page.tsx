									...
									{document.state !== "Unavailable" ? (
										...
										>
											...
											<div className="z-30 flex items-center space-x-3">
												...
												/>
												<h3
													className="z-30 font-semibold text-md text-zinc-900 dark:text-zinc-50 "
												>
													{document.name}
												</h3>
											</div>
											<p
												className="z-30 text-sm text-zinc-500 dark:text-zinc-400 "
											>
												{document.description}
											</p>
